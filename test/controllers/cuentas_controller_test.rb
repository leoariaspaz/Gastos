...
class CuentasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuenta" do
    assert_difference('Cuenta.count') do
      post cuentas_url, params: { cuenta: { descripcion: @cuenta.descripcion, saldo_inicial: @cuenta.saldo_inicial } }
    end
  ...
  test "should update cuenta" do
    patch cuenta_url(@cuenta), params: { cuenta: { descripcion: @cuenta.descripcion, saldo_inicial: @cuenta.saldo_inicial } }
